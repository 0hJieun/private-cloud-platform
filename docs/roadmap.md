...
- Prometheus/node exporter 5개 target, Grafana node·Gluster brick dashboard
...
5. admin은 portal의 예약 자원과 Grafana의 host·storage 지표를 함께 확인한다.
...
- VM guest별 exporter, control-plane custom metrics, alert rule·notification
